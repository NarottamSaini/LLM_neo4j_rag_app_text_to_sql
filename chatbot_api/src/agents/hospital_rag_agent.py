...
hospital_agent_prompt = hub.pull("hwchase17/openai-functions-agent") ##hub.pull('hwchase17/open-ai-functions-agent')

print("hospital_agent_prompt : ", hospital_agent_prompt)
