...
print("HOSPITALS_CSV_PATH : ", HOSPITALS_CSV_PATH)
print("PAYERS_CSV_PATH : ", PAYERS_CSV_PATH)
print("PHYSICIANS_CSV_PATH : ", PHYSICIANS_CSV_PATH)
print("VISITS_CSV_PATH : ", VISITS_CSV_PATH)
